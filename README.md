...
Finally, import the newly created `.scss` file instead of the default Bootstrap `.css` in the beginning of your `src/counter.js` file, for example:
...
following in their [`src/counter.js`](src/counter.js) file:
...
- If the watcher doesn’t see a file called `counter.js` and you’re referencing it by the folder name, you [need to restart the watcher](https://github.com/facebook/create-react-app/issues/1164) due to a Webpack bug.
